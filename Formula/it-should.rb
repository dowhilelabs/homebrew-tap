class ItShould < Formula
  ...
  version "0.2.0"
  url "https://github.com/dowhilelabs/it-should/releases/download/v0.2.0/it-aarch64-apple-darwin.tar.gz"
  # SHA-256 of it-aarch64-apple-darwin.tar.gz (v0.2.0 release).
